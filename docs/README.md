...
| 3 | [`GATES.md`](GATES.md) | You need to know what "done" means — and where T2URL actually stands |
| 4 | [`BUSINESS_CASE.md`](BUSINESS_CASE.md) | You are scoring this, or writing the case for your own accelerator |
| 5 | [`OPERATING_MODEL.md`](OPERATING_MODEL.md) | A pointer to the canonical Forge operating model, plus how T2URL maps onto it |
...
- **Write it before you build it.** `ARCHITECTURE.md` and `BUSINESS_CASE.md` are
  ...
  decision.
- **State gaps here, not in a review.** [`GATES.md`](GATES.md#where-t2url-stands)
  says T2URL is ⚠️ on Harden and names all three reasons. A known gap you wrote down
...
the Forge template repository. T2URL carries only the pointer in
