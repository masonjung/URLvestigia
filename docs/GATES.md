...
| **Harden** | ⚠️ **incomplete** — tests are green (102 passing), but the model card has **no dated eval run**, `raw_searches` has **no row-level retention**, and `ingress_cidrs` still defaults to `0.0.0.0/0` |
